...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        'flex size-full items-center justify-center rounded-full bg-secondary-background font-base text-foreground group-data-[size=lg]/avatar:text-lg group-data-[size=sm]/avatar:text-xs',
        className,
      )}
      {...props}
    />
