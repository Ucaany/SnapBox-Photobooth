...
function Empty({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="empty"
      className={cn(
        'flex w-full min-w-0 flex-1 flex-col items-center justify-center gap-4 rounded-base border-2 border-dashed border-border bg-background p-6 text-center font-base text-balance text-foreground md:p-12',
        className,
      )}
      {...props}
    />
...
function EmptyTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('text-sm font-heading tracking-tight', className)}
      {...props}
    />
  );
}
