...
function QuestionnaireTitle({
  ...
  return (
    <QuestionnairePrimitive.Title
      ...
      className={cn(
        'text-base leading-snug font-heading text-pretty text-foreground [&:not(:has(~[data-slot=questionnaire-description]))]:mb-4',
        className,
      )}
      {...props}
    />
  ...
  return (
    ...
    >
      ...
      <span
        ...
        className="pointer-events-none relative flex size-4 shrink-0 translate-y-[--spacing(0.45)] items-center justify-center rounded-base border-2 border-border bg-secondary-background text-main-foreground group-has-data-[slot=questionnaire-choice-description]/questionnaire-choice:translate-y-0.5 group-data-checked/questionnaire-choice:bg-main group-data-[type=radio]/questionnaire-choice:rounded-full group-data-checked/questionnaire-choice:group-data-[type=radio]/questionnaire-choice:bg-transparent"
      >
        <span
          data-slot="questionnaire-choice-indicator-dot"
          className="hidden size-2 rounded-full bg-current group-data-checked/questionnaire-choice:block group-data-[type=checkbox]/questionnaire-choice:hidden"
        />
        <CheckIcon
