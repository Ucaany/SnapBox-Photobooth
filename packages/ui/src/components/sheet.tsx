...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        'fixed inset-0 z-50 bg-overlay fill-mode-forwards data-closed:animate-out data-closed:duration-300 data-closed:fade-out-0 data-open:animate-in data-open:duration-500 data-open:fade-in-0',
        className,
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          'fixed z-50 flex flex-col gap-4 border-2 border-border bg-background transition ease-in-out outline-none data-closed:animate-out data-closed:duration-300 data-open:animate-in data-open:duration-500',
          side === 'right' &&
      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            className="absolute top-4 right-4 rounded-base ring-offset-white focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none disabled:pointer-events-none"
          >
            <X className="h-4 w-4" />
